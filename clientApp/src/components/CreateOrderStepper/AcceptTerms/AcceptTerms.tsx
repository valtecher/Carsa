...
const AcceptTerms = ({ next }:Props) => {


  return(
    <div className='acceptTerms'>
      <Paper className='acceptTerms-paper' size='xla'>
        <div className='acceptTerms-paper-header'>
          Accept terms
        </div>
        <div className='acceptTerms-paper-body'>
          ...
          Ipsum.Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of 
        ...
        <div className='acceptTerms-paper-footer'>
          <div className='acceptTerms-paper-footer-btn' onClick={() => { next(true)}}>Accept</div>
        </div>
      </Paper>
    </div>
  )
